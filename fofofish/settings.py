...
CENTRIFUGO_TOKEN_TTL_SECONDS = int(os.getenv('CENTRIFUGO_TOKEN_TTL_SECONDS', '7200'))
...
CLASSES_USER_ROLE_FIELD = os.getenv('CLASSES_USER_ROLE_FIELD', 'role')
CLASSES_TEACHER_ROLE_VALUE = os.getenv('CLASSES_TEACHER_ROLE_VALUE', 'teacher')
CLASSES_STUDENT_ROLE_VALUE = os.getenv('CLASSES_STUDENT_ROLE_VALUE', 'user')
CLASSES_MAX_STUDENTS_DEFAULT = int(os.getenv('CLASSES_MAX_STUDENTS_DEFAULT', '100'))
CLASSES_MAX_STUDENTS_HARD_LIMIT = int(os.getenv('CLASSES_MAX_STUDENTS_HARD_LIMIT', '500'))
CLASSES_MESSAGE_HISTORY_LIMIT = int(os.getenv('CLASSES_MESSAGE_HISTORY_LIMIT', '300'))
CLASSES_REACTION_RATE_LIMIT = int(os.getenv('CLASSES_REACTION_RATE_LIMIT', '10'))
