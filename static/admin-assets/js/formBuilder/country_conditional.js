...
console.log(lang)
const countryFieldId = document.getElementById("country_field_id").value;
function loadConditionalSteps(){


    fetch(`/${lang}/api/form-builder/country-field/${countryFieldId}/conditionals/steps/`)
        .then(res => res.text())
        .then(html => {
...
function openCreateConditionalStep(fieldDetailId) {
    ...
    fetch(`/${lang}/api/form-builder/country-field/${countryFieldId}/conditionals/steps/form/?field_detail_id=${fieldDetailId}`)
        .then(res => res.text())
        .then(html => {
...
function openConditionalStepEdit(fieldDetailId, step) {
    ...
    fetch(`/${lang}/api/form-builder/country-field/${countryFieldId}/conditionals/steps/${step}/edit/?field_detail_id=${fieldDetailId}`)
        .then(res => res.text())
        .then(html => {
...
function saveConditionalStep() {
    ...
    if (step) {
        url = `/${lang}/api/form-builder/country-field/${countryFieldId}/conditionals/steps/${step}/edit/`
    } else {
        url = `/${lang}/api/form-builder/country-field/${countryFieldId}/conditionals/steps/create/`
    }
...
function confirmDeleteConditionalStep(){
    ...
    fetch(`/${lang}/api/form-builder/country-field/${countryFieldId}/conditionals/steps/${DELETE_STEP}/delete/`,{
        method:"POST",
        body:formData,
        headers:{
            "X-CSRFToken":csrf_token
...
function submitCreateConditionalStep() {
    ...
    const countryFieldId = CURRENT_CATEGORY_FIELD_ID

    const data = collectConditionalFields()

    const formData = new FormData()

    formData.append("country_field_id", countryFieldId)
