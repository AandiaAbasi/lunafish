...
function loadSteps(){
    ...
    fetch(`/${lang}/api/form-builder/category/${category_id}/steps/`)
    .then(res => res.text())
    .then(html => {
...
function saveStep(step = null) {
    ...
    let url = `/${lang}/api/form-builder/category/${category_id}/steps/create/`;
    if (step) {
        url = `/${lang}/api/form-builder/category/${category_id}/steps/${step}/edit/`;
    }
...
function confirmDeleteStep(){
    ...
    fetch(`/${lang}/api/form-builder/category/${category_id}/steps/${DELETE_STEP_ID}/delete/`,{
        method:"POST",
        headers:{
            "X-CSRFToken": csrf_token
        }
...
function editStep(step){
    ...
    fetch(`/${lang}/api/form-builder/category/${category_id}/steps/${step}/edit/`)
    .then(res=>res.text())
    .then(html=>{
    ...
    if (!stepSortable) {
        stepSortable = new Sortable(container, {
            ...
            onEnd: function () {
                ...
                fetch(`/${lang}/api/form-builder/category/${category_id}/steps/reorder/`, {
                    method: "POST",
                    headers: {
        ...
        if (!fieldSortables[stepId]) {
            fieldSortables[stepId] = new Sortable(list, {
                ...
                onEnd: function () {
                    ...
                    fetch(`/${lang}/api/form-builder/category/${category_id}/fields/reorder/`, {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            "X-CSRFToken": csrf_token
...
function openConditional(categoryFieldId){

    window.location.href =
        `/${lang}/api/form-builder/category-field/${categoryFieldId}/conditionals/`;
