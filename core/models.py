...
class Contact(BaseModel):
    ...
    type = models.CharField(max_length=50, choices=CHOICES, default="phone", verbose_name=_("Type"))
...
class Banner(BaseModel):
    ...
    sub_title = models.CharField(max_length=100, null=True, blank=True, verbose_name=_("Subtitle"))
    image = models.ImageField(upload_to=upload_to_dynamic, verbose_name=_("Image"))
    link = models.CharField(max_length=100, null=True, blank=True, verbose_name=_("Link"), help_text=_("Example: https://example.com"))
